...
{								//Début de mon bloc de code.
	...
	//Stock ce que l'utilisateur a entré, dans la variable iNombre.
	cin >> iNombre;

	// (Avec la logique où si un nombre divisé par 2 n'as aucun reste, c'est que celui-ci est un nombre pair. Sinon, il est définitivement impair.)
